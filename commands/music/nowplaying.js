...
code: `
$interactionFollowUp[;{newEmbed: {title:Now playing} {field:Link:[$songInfo[title]]($songInfo[url]):yes} {field:Duration: \`$humanizeMS[$getCurrentDuration]/$humanizeMs[$songInfo[duration]]\`:yes} {field:Author:**$songInfo[author]**:yes} 
...
$onlyif[$voiceID[$authorID]!=;{"embeds" : "{newEmbed:{title:$getVar[wrong] Error Occured} {description: You have to join a voice channel} {color:RED}}",
"ephemeral" : true,
"options": { "interaction": true }
}]
