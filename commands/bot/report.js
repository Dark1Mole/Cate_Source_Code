...
$channelSendMessage[952584324010606632;<@$botOwnerID> {newEmbed:{title:<:icons_outage:952574210360885258> New Bug} {field:User_ID:$findUser[$username]} {timestamp:ms} {field:Issue:\`$slashOption[bug]\`} {thumbnail:$userAvatar[$findUser[$username]]} {color:RED}};no]
